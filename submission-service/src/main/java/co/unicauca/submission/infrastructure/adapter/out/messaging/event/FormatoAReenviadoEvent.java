...
/**
 * Evento de integración: Formato A Reenviado (v2/v3).
 *
 * Evento enriquecido con información completa para progress-tracking.
 * Estructura idéntica a FormatoAEnviadoEvent pero con version > 1.
 */
public class FormatoAReenviadoEvent implements DomainEvent {
    ...
    private FormatoAReenviadoEvent(Builder builder) {
        ...
        this.descripcion = builder.descripcion != null ? builder.descripcion : "Formato A v" + version + " con correcciones";
    ...
    public static class Builder {
        ...
        public FormatoAReenviadoEvent build() {
            if (proyectoId == null) throw new IllegalStateException("proyectoId es requerido");
            if (version == null || version < 2) throw new IllegalStateException("version debe ser >= 2");
            ...
            return new FormatoAReenviadoEvent(this);
        }
    }
}
