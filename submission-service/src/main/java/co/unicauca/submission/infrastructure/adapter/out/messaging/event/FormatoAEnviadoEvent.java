...
/**
 * Evento de integración: Formato A Enviado (v1).
 *
 * Evento enriquecido con información completa de participantes para progress-tracking.
 * Este evento incluye nombres y emails obtenidos de identity-service.
 */
public class FormatoAEnviadoEvent implements DomainEvent {
    ...
    private FormatoAEnviadoEvent(Builder builder) {
        ...
        this.descripcion = builder.descripcion != null ? builder.descripcion : "Primera versión del Formato A";
    ...
    public static class Builder {
        ...
        public FormatoAEnviadoEvent build() {
            ...
            return new FormatoAEnviadoEvent(this);
        }
    }
}
