...
public class ProyectoSubmission {
    ...
    // SOPORTA NOMBRES VIEJOS Y NUEVOS PARA COMPATIBILIDAD CON BD EXISTENTE
    private IEstadoSubmission obtenerEstadoPorNombre(String nombre) {
        ...
        return switch (nombre) {
            ...
            // Nuevos nombres (correctos según RF-3)
            ...
            // Nombres viejos (para compatibilidad con datos existentes en BD)
